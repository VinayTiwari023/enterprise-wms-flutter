...
class PrintingService {
  ...
  static Future<void> printManifest(List<dynamic> orders) async {
    final pdf = pw.Document();
          ...
          return pw.Column(
            ...
            children: [
              ...
              pw.Row(
                mainAxisAlignment: pw.MainAxisAlignment.spaceBetween,
                children: [
                  pw.Text('Carrier Signature: ____________________'),
                  pw.Text('Generated by WMS Mobile'),
                ],
              ),
            ],
    ...
    await Printing.layoutPdf(
      onLayout: (PdfPageFormat format) async => pdf.save(),
      name: 'Shipping_Manifest_${DateTime.now().millisecondsSinceEpoch}',
    );
  }
}
